<div class="form-container-health">
    ...
    <div class="health-form">
        ...
        <div class="form-group-health">
            ...
            <input type="text" id="underlying_disease" name="underlyingdisease" class="form-control-health" value="{{ $underlying_disease }}"wire:model="underlying_disease">
        </div>
        {{-- <div>
            Current bloodtype: {{ $this->blood_ldl }}
        </div> --}}
        ...
        <div class="form-group-health">
            ...
            <div class="radio-group">
                <label for="bloodtypeA">
                    <input type="radio" id="bloodtypeA" name="bloodtype" value="A" wire:model="blood_type" @checked($this->blood_type == 'A')>

                    <span class="radio-label"> A </span>
                </label>

                <label for="bloodtypeB">
                    <input type="radio" id="bloodtypeB" name="bloodtype" value="B" wire:model="blood_type" @checked($this->blood_type == 'B')>

                    <span class="radio-label"> B </span>
                </label>

                <label for="bloodtypeAB">
                    <input type="radio" id="bloodtypeAB" name="bloodtype" value="AB" wire:model="blood_type" @checked($this->blood_type == 'AB')>
                    <span class="radio-label"> AB </span>
                </label>
                <label for="bloodtypeO">
                    <input type="radio" id="bloodtypeO" name="bloodtype" value="O" wire:model="blood_type" @checked($this->blood_type == 'O')>
        ...
        <div class="form-row-inline-health">
            ...
            <div class="form-group-health">
                ...
                <input type="number" id="bloodldl" name="bloodldl"  wire:model="blood_ldl">
            </div>
            <!-- Number input for HFL -->
            <div class="form-group-health">
                <label for="bloodhfl">ค่าเลือด HFL</label>
                <input type="number" id="bloodhfl" name="bloodhfl"   wire:model="blood_hfl">
            </div>
        ...
        <div class="form-group-health">
            ...
            <input type="text" id="regular_medication" name="regular_medication" class="form-control-health" wire:model="regular_medication">
        </div>

        <div class="form-group-health">
            <label for="sideeffects">อาการข้างเคียง</label>
            <input type="text" id="sideeffects" name="sideeffects" class="form-control-health" value="{{ $side_effects }}" wire:model="side_effects">
        </div>
